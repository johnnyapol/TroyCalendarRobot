...
class Date: 
    ...
    def get_tomorrow(self):
        ...
        if (self.month - 1 is 1):
            leap_year = ((self.year % 4 == 0 and self.year % 100 is not 0) or year % 400 is 0)
        ...
        print("Today: " + str(self.month) + "/" + str(self.day) + "/" + str(self.year) + "\n")
        print("Tomorrow: " + str(next_month) + "/" + str(next_day) + "/" + str(next_year) + "\n")
